...
const PHASES = [
  {
    ...
    user_view: "Sieht einen LinkedIn-Post, eine Empfehlung aus dem Branchenkreis oder stolpert über die Build-in-Public-Seite. Erstes Interesse: \"Was würde KI in meinem Haus eigentlich wirklich bringen?\"",
    options: [
      { label: "Direkter LinkedIn-Klick", note: "Persönliches Branding Alex Heyers" },
      { label: "Direkt-Anfrage", note: "Mail an a.heyers@gmail.com" },
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Berater-Invite-Link (geplant P3)", note: "Pilot-Partner legt User vor, Kunde klickt rein" },
    ],
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Berater-begleitet (P3)", note: "Pilot-Partner / Mensch sitzt live im Call dabei" },
  ...
  },
  {
    ...
    subtitle: "30 Min Voice-Interview mit Ada",
